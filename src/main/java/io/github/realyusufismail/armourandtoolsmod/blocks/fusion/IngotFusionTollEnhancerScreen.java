 ...
 */
public class IngotFusionTollEnhancerScreen extends AbstractContainerScreen<IngotFusionTollEnhancerMenu> implements RecipeUpdateListener {
    ...
    public final IngotFusionTollEnhancerRecipeBookComponent recipeBookComponent = new IngotFusionTollEnhancerRecipeBookComponent();
