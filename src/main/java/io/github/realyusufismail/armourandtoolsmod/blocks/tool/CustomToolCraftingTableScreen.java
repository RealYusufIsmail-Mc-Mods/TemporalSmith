 ...
 */
public class CustomToolCraftingTableScreen
    extends AbstractContainerScreen<CustomToolCraftingTableMenu> implements RecipeUpdateListener {
  ...
  public CustomToolCraftingTableScreen(
      CustomToolCraftingTableMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
