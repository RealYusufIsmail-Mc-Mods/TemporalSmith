...
public class ModBlockLootTables extends BlockLootSubProvider {
    ...
    protected void generate() {
        ...
        add(BlockInit.DEEPSLATE_AQUMARINE_ORE.get(), createOreDrop(
                BlockInit.DEEPSLATE_AQUMARINE_ORE.get(), ItemInit.RAW_AQUMARINE.get()));
