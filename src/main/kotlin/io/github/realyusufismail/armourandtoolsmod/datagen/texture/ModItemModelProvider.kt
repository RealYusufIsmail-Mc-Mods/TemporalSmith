...
import io.github.realyusufismail.armourandtoolsmod.core.init.ItemInit.ITEMS
...
class ModItemModelProvider(output: PackOutput, exFileHelper: ExistingFileHelper) :
    ...
    override fun registerModels() {
        // items
        ITEMS.entries.stream().map(RegistryObject<Item>::get).forEach(this::registerItems)
    }

    private fun registerItems(item: Item) {
        TODO()
    }
}
