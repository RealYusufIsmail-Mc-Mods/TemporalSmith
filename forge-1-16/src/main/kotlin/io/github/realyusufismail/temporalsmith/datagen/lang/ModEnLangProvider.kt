...
class ModEnLangProvider(gen: DataGenerator) : LanguageProvider(gen, MOD_ID, "en_us") {
    ...
    override fun addTranslations() {
        ...
        // others
        add("creativetab.temporalsmith", "Temporal Smith")
        ...
        // keybinds
        //        add(KeyBinding.KEY_CATEGORY_TEMPORAL_SMITH_MOD, "Temporal Smith")
        //        add(KeyBinding.KEY_GET_MJOLNIR, "Get Mjölnir")
        //        add(KeyBinding.KEY_STRIKE_LIGHTNING, "Strike Lightning")

        // advancements
        addAdvancement(
            "root", "Download Temporal Smith Mod", "Thanks for downloading Temporal Smith Mod!")
    ...
    private fun add(key: ITextComponent, lang: String) {
        super.add(key.string, lang)
    }

    private fun addAdvancement(advancement: String, title: String, description: String) {
        add(TranslationTextComponent("advancements.$MOD_ID.$advancement.title"), title)
        add(TranslationTextComponent("advancements.$MOD_ID.$advancement.description"), description)
    }

    private fun addPotion(objectName: String, effectName: String, name: String) {
        add(TranslationTextComponent("effect.$MOD_ID.$effectName"), name)
        add(TranslationTextComponent("item.minecraft.potion.effect.$objectName"), name)
        add(TranslationTextComponent("item.minecraft.splash_potion.effect.$objectName"), name)
        add(TranslationTextComponent("item.minecraft.lingering_potion.effect.$objectName"), name)
        add(TranslationTextComponent("item.minecraft.tipped_arrow.effect.$objectName"), name)
    }
}
