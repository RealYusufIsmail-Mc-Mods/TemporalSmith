...
public class EnderiteGolem extends AbstractGolem implements NeutralMob {
    protected static final EntityDataAccessor<Byte> DATA_FLAGS_ID = SynchedEntityData.defineId(EnderiteGolem.class, EntityDataSerializers.BYTE);
    ...
    public static enum Crackiness {
        ...
        private static final List<EnderiteGolem.Crackiness> BY_DAMAGE = Stream.of(values())
