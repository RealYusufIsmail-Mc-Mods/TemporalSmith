 ...
 */ 
package io.github.realyusufismail.temporalsmith.recipe.codec;
...
public record CustomToolCraftingTableRawShapedRecipe(
    String group,
    CustomToolsCraftingBookCategory category,
  ...
  static final Codec<List<String>> PATTERN_CODEC =
      Codec.STRING
          ...
          .flatXmap(
              p_300940_ -> {
                if (p_300940_.size() > CustomToolCraftingTableShapedRecipe.MAX_HEIGHT) {
                  return DataResult.error(
                      () ->
                          "Invalid pattern: too many rows, %s is maximum"
                              .formatted(CustomToolCraftingTableShapedRecipe.MAX_HEIGHT));
                  ...
                  for (String s : p_300940_) {
                    if (s.length() > CustomToolCraftingTableShapedRecipe.MAX_WIDTH) {
                      return DataResult.error(
                          () ->
                              "Invalid pattern: too many columns, %s is maximum"
                                  .formatted(CustomToolCraftingTableShapedRecipe.MAX_WIDTH));
                    }
  ...
  public static final Codec<CustomToolCraftingTableRawShapedRecipe> CODEC =
          ...
          (p_44108_) ->
              p_44108_
                  .group(
                      ...
                      CustomToolsCraftingBookCategory.CODEC
                          .fieldOf("category")
                  ...
                  .apply(p_44108_, CustomToolCraftingTableRawShapedRecipe::new));
}
