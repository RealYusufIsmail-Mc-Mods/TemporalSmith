...
public class CustomArmourCraftingTableScreen
    extends AbstractContainerScreen<CustomArmourCraftingTableMenu> implements RecipeUpdateListener {
  ...
  public CustomArmourCraftingTableScreen(
      CustomArmourCraftingTableMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
